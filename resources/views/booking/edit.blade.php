                    ...
                    <div class="card-header"style="background-color: #000000;">
                        <div class="row align-items-center">
                            ...
                            <div class="col-4 text-right">
                                <a href="{{ route('booking.index' ,$booking->parking_id) }}"
                                class="btn btn-sm btn-primary">{{ __('Back to list') }}</a>
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
                        <form method="post" action="{{ route('booking.update', $booking) }}" autocomplete="off">
                            @csrf
                            @method('put')
                            ...
                            <div class="pl-lg-4">
                              ...
                              <div class="form-group{{ $errors->has('plate_number') ? ' has-danger' : '' }}">
                               ...
                               placeholder="{{ __('plate number') }}" value="{{ old('plate_number', $booking->plate_number) }}" required>
                           ...
                           <div class="form-group{{ $errors->has('username') ? ' has-danger' : '' }}">
                               ...
                               placeholder="{{ __('username') }}" value="{{ old('username', $booking->username) }}" readonly>
