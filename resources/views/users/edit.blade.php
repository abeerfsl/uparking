                    ...
                    <div class="card-body">
                        <form method="post" action="{{ route('user.update', $user) }}" autocomplete="off">
                            ...
                            <div class="pl-lg-4">
                                ...
                                <div class="form-group">
                                    <label class="form-control-label" for="input-isBan">{{ __('Accounut State') }}</label>
                                    <input type="isBan" name="isBan" id="input-isBan" class="form-control form-control-alternative" placeholder="{{ __('state') }}" value="{{ old('isBan', $user->isBan) }}">
                                </div>
