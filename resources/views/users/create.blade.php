                ...
                <div class="card">
                    <div class="card-header"style="background-color: #000000;">
                        <div class="row align-items-center">
                            <div class="col-8">
                                <h3 class="mb-0">{{ __('Administrator') }}</h3>
                            </div>
                    ...
                    <div class="card-body">
                        <form method="post" action="{{ route('user.store') }}" autocomplete="off">
                            ...
                            <!--  <div class="tab-content">
                              ...
                              <!-- <div class="form-group">
                                  <label class="form-control-label" for="input-isBan">{{ __('Account State') }}</label>
                                  <input type="isBan" name="isBan" id="input-isBan" class="form-control form-control-alternative" placeholder="{{ __('0 or 1') }}" value="" required>
                              </div> -->
