...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class=" rtl menu-on-right ">
        @auth()
            <div class="wrapper">
                    @include('layouts.navbars.sidebarrtl')
                <div class="main-panel">
                    @include('layouts.navbars.navbarrtl')
        ...
        <div class="fixed-plugin " >
            <div class="dropdown show-dropdown ml-auto" >
                <a href="#" data-toggle="dropdown">
                <i class="fa fa-heart fa-2x" style="float:left;"></i>
                </a>
                <ul class="dropdown-menu menu-on-left">
